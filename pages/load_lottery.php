...
$lottery_prize = (float)(getSetting('lottery_prize') ?: 500);
...
if (isset($_GET['claim_ticket'])) {
    ...
    try {
        ...
        $pdo->commit();
        echo json_encode(['status' => 'success', 'ticket' => $ticketNumber, 'msg' => 'Ticket #' . $ticketNumber . ' claimed!']);
    } catch (Exception $e) {
...
<div class="space-y-4 pb-4">
        ...
        <div class="relative overflow-hidden rounded-[calc(0.75rem-1px)] bg-gradient-to-br from-violet-600 via-purple-600 to-cyan-500 p-5">
            ...
            <div class="relative flex items-center gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-violet-100 text-xs font-medium mt-0.5">Win <b><?php echo number_format($lottery_prize, 0); ?></b> coins every week!</p>
                </div>
                <?php if ($drawIsActive): ?>
    ...
    <div class="grid grid-cols-3 gap-3">
        <div class="bg-white/80 dark:bg-white/5 border border-gray-200 dark:border-violet-500/10 rounded-xl p-3 text-center backdrop-blur-sm">
            <div class="text-lg font-extrabold bg-gradient-to-r from-violet-500 to-purple-500 bg-clip-text text-transparent"><?php echo number_format($lottery_prize, 0); ?></div>
