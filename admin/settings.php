            ...
            <div class="w-full max-w-6xl mx-auto space-y-8">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="space-y-8">
                        ...
                        <section id="ad_setup_link">
                            <div class="bg-white/80 dark:bg-dark-800/80 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm">
                                <div class="flex items-center justify-between">
                                    <h3 class="text-lg font-extrabold text-blue-500 flex items-center gap-2"><i class="fas fa-rectangle-ad"></i> Ad Setup & Faucet</h3>
                                    <a href="ad_setup.php" class="px-5 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-bold text-sm transition-all"><i class="fas fa-arrow-right mr-1"></i> Open Ad Setup</a>
                                </div>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Ad networks, daily limits, and faucet settings are now managed from the dedicated Ad Setup page.</p>
                            </div>
                        </section>
