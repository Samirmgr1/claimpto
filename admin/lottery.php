...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_action'])) {
    ...
    if ($action === 'draw_now') {
        ...
        try {
            ...
            $prize = (float)(getSetting('lottery_prize') ?: 0) + (float)$draw['prize_pool'];
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400 flex flex-wrap gap-3 mt-1">
                                        <span><i class="fas fa-coins text-violet-500 mr-1"></i> Prize: <b><?php echo number_format((float)($lottery_prize) + (float)$d['prize_pool'], 0); ?></b></span>
